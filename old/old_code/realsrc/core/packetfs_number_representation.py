...
class PacketFSNumberSystem:
    ...
    def calculate_packetfs_base_efficiency(self):
        ...
        print(
            f"   • Hypercore (1.3M): needs {hypercore_symbols_needed} decimal symbols"
        )
        ...
        return {
            ...
            "hypercore_symbols": (
                1
                if self.unicode_private_use > hypercore_base
                else hypercore_symbols_needed
            ),
            "hshard_symbols": (
                1 if self.unicode_private_use > hshard_base else hshard_symbols_needed
            ),
        }
