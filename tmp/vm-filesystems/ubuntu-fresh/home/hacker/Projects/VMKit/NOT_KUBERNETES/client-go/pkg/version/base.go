...
var (
	...
	gitVersion   string = "v0.0.0-master+b94b6ece10d813603c625d1b39ec2cd4c680897f"
	gitCommit    string = "b94b6ece10d813603c625d1b39ec2cd4c680897f" // sha1 from git, output of $(git rev-parse HEAD)
